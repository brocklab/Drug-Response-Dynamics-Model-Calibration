...
%This version is for model 1, which incorporates a proliferation delay
%(t_r) and an exponential delay on sensitive cell death.

function [error_vector] = Model_1_Lst_Sq_Function(z,count,t_vector,N_init,g_0,t_r)
f_r = z(1);
g_r = z(2);
k_D = z(3);
N_max = z(4);
...
prediction = Model_1_Forward(N_init,t_vector,g_0,N_max,f_r,g_r,k_D,t_d,t_r);
