...
%This version is for model 2, with 100% of the cells assumed to be
%sensitive, and is used only when manual observation confirms that no cells
%recovered during the experiment.

function [error_vector] = Model_2_Death_Only_Lst_Sq_Function(z,count,t_vector,N_init,g_0)
k_D = z(1);
t_d = z(2);


prediction = Model_2_Death_Only_Forward(N_init,t_vector,g_0,k_D,t_d);
