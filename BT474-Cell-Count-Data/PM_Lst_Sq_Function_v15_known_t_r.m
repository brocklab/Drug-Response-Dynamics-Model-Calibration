...
function [error_vector] = PM_Lst_Sq_Function_v15_known_t_r(z,count,t_vector,N_init,g_0,t_r)
f_r = z(1);
g_r = z(2);
k_D = z(3);
t_d = z(4);
...
prediction = PM_Forward_v15(N_init,t_vector,g_0,N_max,f_r,g_r,k_D,t_d,t_r);
