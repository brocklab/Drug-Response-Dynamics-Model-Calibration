...
%an exponential time delay on the cell death term.

function [forward_model] = PM_Forward_v15(N_init,t_vector,g_0,N_max,f_r,g_r,k_D,t_d,t_r)
...
for i = 2:lgth
    k = k_D-(k_D+g_0)*exp(-t_d*(t_vector(i)));
        if t_vector(i)<t_r
